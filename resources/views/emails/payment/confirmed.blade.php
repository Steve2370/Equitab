...
.btn-primary { background: #10B981 !important; }
    ...
    <!-- Hero -->
      ...
      >Bonjour <strong>{{ $memberName }}</strong>, votre abonnement est actif.</div>
    ...
    <!-- Détails paiement -->
      ...
      <div
         style="font-family:Montserrat, Arial, sans-serif;font-size:18px;font-weight:600;line-height:1.6;text-align:left;color:#0B1929;"
      >{{ $groupName }}</div>
              ...
              <tr>
                <td
                   align="center" style="font-size:0px;padding:12px 0;word-break:break-word;"
                >
                  
      <p
         style="border-top:solid 1px #D1FAE5;font-size:1px;margin:0px auto;width:100%;"
      >
      </p>
      
      <!--[if mso | IE]><table align="center" border="0" cellpadding="0" cellspacing="0" style="border-top:solid 1px #D1FAE5;font-size:1px;margin:0px auto;width:488px;" role="presentation" width="488px" ><tr><td style="height:0;line-height:0;"> &nbsp;
</td></tr></table><![endif]-->
      ...
      >
        <tr>
            <td style="padding: 4px 0; color: #6B7280; font-size: 14px;">Montant débité</td>
            <td style="padding: 4px 0; color: #0B1929; font-weight: 600; text-align: right;">{{ $amount }} $ CAD</td>
          </tr>
          <tr>
            <td style="padding: 4px 0; color: #6B7280; font-size: 14px;">Service</td>
            <td style="padding: 4px 0; color: #0B1929; font-weight: 600; text-align: right;">{{ $subscriptionName }}</td>
          </tr>
          <tr>
            <td style="padding: 4px 0; color: #6B7280; font-size: 14px;">Prochain renouvellement</td>
            <td style="padding: 4px 0; color: #0B1929; font-weight: 600; text-align: right;">{{ $nextBillingDate }}</td>
          </tr>
      </table>
    ...
    <!-- Identifiants -->
      ...
      >🔑 Accédez à vos identifiants</div>
      ...
      >Vos identifiants de connexion sont disponibles dans votre tableau de bord Equitab, dans la section "Abonnements rejoints".</div>
    ...
    <!-- Footer -->
      ...
      <div
         style="font-family:Montserrat, Arial, sans-serif;font-size:12px;line-height:1.6;text-align:center;color:#9CA3AF;"
      >Si vous n'êtes pas à l'origine de ce paiement, contactez-nous à
          <a href="mailto:support@equitab.ca" style="color: #10B981;">support@equitab.ca</a></div>
