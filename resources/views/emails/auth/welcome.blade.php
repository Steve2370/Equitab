...
<html lang="und" dir="auto" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  <head>
    ...
    <!-- Hero -->
      ...
      <div  style="background:#0B1929;background-color:#0B1929;margin:0px auto;max-width:600px;">
        ...
        >
          <tbody>
            <tr>
              <td
                 style="direction:ltr;font-size:0px;padding:0 32px 48px;text-align:center;"
              >
                <!--[if mso | IE]><table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td class="" style="vertical-align:top;width:536px;" ><![endif]-->
      ...
      <div
         style="font-family:Montserrat, Arial, sans-serif;font-size:32px;font-weight:700;line-height:1.3;text-align:center;color:#FFFFFF;"
      >Bienvenue sur Equitab</div>
              ...
              <tr>
                <td
                   align="center" style="font-size:0px;padding:10px 25px;padding-top:12px;word-break:break-word;"
                >
                  
      <div
         style="font-family:Montserrat, Arial, sans-serif;font-size:16px;line-height:1.6;text-align:center;color:#94A3B8;"
      >Bonjour <strong style="color: #10B981;">{{ $userName }}</strong>, votre compte est créé avec succès.</div>
    ...
    <!-- Features -->
      ...
      >
        <tbody>
              ...
              <tr>
                <td
                   align="center" style="font-size:0px;padding:10px 25px;padding-bottom:24px;word-break:break-word;"
                >
                  
      <div
         style="font-family:Montserrat, Arial, sans-serif;font-size:18px;font-weight:700;line-height:1.6;text-align:center;color:#0B1929;"
      >Tout ce que vous pouvez faire avec Equitab</div>
      ...
      >
        <tbody>
          <tr>
            <td  style="background-color:#F0FDF4;border-radius:12px;vertical-align:top;border-collapse:separate;padding:20px;">
      ...
      >Économisez sur vos abonnements</div>
      ...
      <div
         style="font-family:Montserrat, Arial, sans-serif;font-size:14px;line-height:1.6;text-align:left;color:#6B7280;"
      >Rejoignez des groupes existants et partagez les frais de Netflix, Spotify, Disney+ et plus encore.</div>
      ...
      <div
         style="font-family:Montserrat, Arial, sans-serif;font-size:15px;font-weight:600;line-height:1.6;text-align:left;color:#0B1929;"
      >Paiements sécurisés par Stripe</div>
      ...
      <div
         style="font-family:Montserrat, Arial, sans-serif;font-size:14px;line-height:1.6;text-align:left;color:#6B7280;"
      >Votre argent ne transite jamais par Equitab.</div>
      ...
      <div
         style="font-family:Montserrat, Arial, sans-serif;font-size:14px;line-height:1.6;text-align:left;color:#6B7280;"
      >Créez un groupe et invitez des membres pour récupérer une partie de vos frais chaque mois.</div>
    ...
    <!-- Étapes -->
      ...
      <div
         style="font-family:Montserrat, Arial, sans-serif;font-size:18px;font-weight:700;line-height:1.6;text-align:left;color:#0B1929;"
      ...
      >
        <tr>
            <td style="padding: 8px 0; vertical-align: top;">
              <span style="background: #10B981; color: white; border-radius: 50%; width: 24px; height: 24px; display: inline-block; text-align: center; line-height: 24px; font-size: 12px; font-weight: 700;">1</span>
            </td>
            <td style="padding: 8px 0 8px 12px; color: #374151; font-size: 14px;">
              <strong>Vérifiez votre identité</strong> : requis pour créer un groupe et recevoir des paiements.
            </td>
          </tr>
          <tr>
            <td style="padding: 8px 0; vertical-align: top;">
              <span style="background: #10B981; color: white; border-radius: 50%; width: 24px; height: 24px; display: inline-block; text-align: center; line-height: 24px; font-size: 12px; font-weight: 700;">2</span>
            </td>
            <td style="padding: 8px 0 8px 12px; color: #374151; font-size: 14px;">
              <strong>Explorez les groupes disponibles</strong> : trouvez un abonnement à rejoindre.
            </td>
          </tr>
          <tr>
            <td style="padding: 8px 0; vertical-align: top;">
              <span style="background: #10B981; color: white; border-radius: 50%; width: 24px; height: 24px; display: inline-block; text-align: center; line-height: 24px; font-size: 12px; font-weight: 700;">3</span>
            </td>
            <td style="padding: 8px 0 8px 12px; color: #374151; font-size: 14px;">
              <strong>Payez et accédez</strong> : recevez les identifiants immédiatement après le paiement.
            </td>
          </tr>
      </table>
      ...
      >
        <tbody>
          <tr>
            ...
            >
              <a
                 href="{{ $exploreUrl }}" style="display:inline-block;background:#10B981;color:#FFFFFF;font-family:Montserrat, Arial, sans-serif;font-size:15px;font-weight:600;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:14px 48px;mso-padding-alt:0px;border-radius:8px;" target="_blank"
              >
