...
<html lang="und" dir="auto" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  <head>
    ...
    @media only screen and (max-width:479px) {
      ...
      >Bonjour <strong>{{ $userName }}</strong>, votre identité a été confirmée avec succès par Stripe Identity.</div>
      ...
      >Ce que vous pouvez faire maintenant :</div>
      ...
      >Pour commencer à partager vos abonnements, configurez votre compte bancaire via Stripe Connect depuis votre profil.</div>
