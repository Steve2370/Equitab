...
<html lang="und" dir="auto" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  <head>
    ...
    <!-- Hero -->
      ...
      >Renouvellement dans 3 jours</div>
      ...
      >Bonjour <strong>{{ $memberName }}</strong>, votre abonnement sera renouvelé automatiquement.</div>
    ...
    <!-- Détails -->
      ...
      >
        <tr>
          ...
          <tr>
            <td style="padding: 6px 0; color: #6B7280; font-size: 14px;">Montant à débiter</td>
            <td style="padding: 6px 0; color: #C2410C; font-weight: 700; text-align: right;">{{ $amount }} $ CAD</td>
          </tr>
          <tr>
            <td style="padding: 6px 0; color: #6B7280; font-size: 14px;">Date de renouvellement</td>
            <td style="padding: 6px 0; color: #0B1929; font-weight: 600; text-align: right;">{{ $renewalDate }}</td>
          </tr>
      </table>
    ...
    <!-- Info -->
      ...
      >Renouvellement automatique</div>
      ...
      >Votre carte sera débitée automatiquement le {{ $renewalDate }}. Si vous souhaitez annuler, faites-le avant cette date depuis votre tableau de bord.</div>
