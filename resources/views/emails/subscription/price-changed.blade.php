...
<html lang="und" dir="auto" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  <head>
    ...
    <style media="screen and (min-width:480px)">
      ...
      >{{ $isDecrease ? 'Bonne nouvelle !' : 'Mise à jour de prix' }}</div>
      ...
      >Bonjour <strong>{{ $memberName }}</strong>, votre quote-part a {{ $isDecrease ? 'baissé' : 'changé' }}.</div>
      ...
      >{{ $groupName }} — {{ $subscriptionName }}</div>
      ...
      >
        <tr>
                <td style="padding: 8px 0; color: #6B7280; font-size: 14px;">Ancien prix</td>
                <td style="padding: 8px 0; color: #9CA3AF; text-decoration: line-through; text-align: right;">{{ $oldPrice }} $ CAD</td>
            </tr>
            <tr>
                <td style="padding: 8px 0; color: #6B7280; font-size: 14px;">Nouveau prix</td>
                <td style="padding: 8px 0; color: #10B981; font-weight: 700; font-size: 18px; text-align: right;">{{ $newPrice }} $ CAD</td>
            </tr>
      </table>
      ...
      >
        <tbody>
          <tr>
            <td  style="background-color:#FFF7ED;border-radius:12px;vertical-align:top;border-collapse:separate;padding:24px;">
      ...
      >
        <tr>
            ...
            <tr>
                <td style="padding: 8px 0; color: #6B7280; font-size: 14px;">Nouveau prix</td>
                <td style="padding: 8px 0; color: #C2410C; font-weight: 700; font-size: 18px; text-align: right;">{{ $newPrice }} $ CAD</td>
            </tr>
      </table>
      ...
      >{{ $isDecrease ? 'De nouveaux membres ont rejoint le groupe, ce qui réduit la part de chacun.' : 'Un membre a quitté le groupe, ce qui augmente la part des membres restants.' }}
          Ce nouveau prix s'applique à votre prochain renouvellement.</div>
      ...
      >
        <tbody>
          <tr>
            <td
               align="center" bgcolor="#0B1929" role="presentation" style="border:none;border-radius:8px;cursor:auto;mso-padding-alt:14px 48px;background:#0B1929;" valign="middle"
            >
              <a
                 href="{{ $dashboardUrl }}" style="display:inline-block;background:#0B1929;color:#FFFFFF;font-family:Montserrat, Arial, sans-serif;font-size:15px;font-weight:600;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:14px 48px;mso-padding-alt:0px;border-radius:8px;" target="_blank"
              >
