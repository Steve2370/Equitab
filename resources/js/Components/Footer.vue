            ...
            <div class="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div>
                    ...
                    <div class="mt-5 flex items-center gap-3">
                        ...
                        <a href="#" class="flex h-8 w-8 items-center justify-center rounded-lg bg-white/10 hover:bg-white/20 transition-colors">
                        ...
                        <a href="www.linkedin.com/in/brice-steve-tchagam-youatchui-656aa1205" class="flex h-8 w-8 items-center justify-center rounded-lg bg-white/10 hover:bg-white/20 transition-colors">
